...
-- changeset root:1757707908383-13 splitStatements:false
...
-- changeset root:1757707908383-16 splitStatements:false
CREATE INDEX "idx_user_sessions_user_id" ON "public"."user_sessions" USING btree("user_id");
-- rollback DROP INDEX IF EXISTS "idx_user_sessions_user_id";

-- changeset root:1757707908383-17 splitStatements:false
CREATE INDEX "idx_user_sessions_expires_at" ON "public"."user_sessions" USING btree("expires_at");
-- rollback DROP INDEX IF EXISTS "idx_user_sessions_expires_at";

-- changeset root:1757707908383-18 splitStatements:false
...
-- changeset root:1757707908383-1 splitStatements:false
...
-- changeset root:1757707908383-2 splitStatements:false
...
-- changeset root:1757707908383-3 splitStatements:false
...
-- changeset root:1757707908383-4 splitStatements:false
...
-- changeset root:1757707908383-5 splitStatements:false
...
-- changeset root:1757707908383-6 splitStatements:false
ALTER TABLE "public"."users" ALTER COLUMN  "created_at" SET DEFAULT NOW();
-- rollback ALTER TABLE "public"."users" ALTER COLUMN "created_at" DROP DEFAULT;

-- changeset root:1757707908383-7 splitStatements:false
...
-- changeset root:1757707908383-8 splitStatements:false
...
-- changeset root:1757707908383-9 splitStatements:false
...
-- changeset root:1757707908383-10 splitStatements:false
...
-- changeset root:1757707908383-11 splitStatements:false
...
-- changeset root:1757707908383-12 splitStatements:false
