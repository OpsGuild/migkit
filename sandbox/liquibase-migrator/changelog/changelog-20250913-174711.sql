...
-- changeset liquibase-user:1757785640741-1 splitStatements:false
...
-- changeset liquibase-user:1757785640741-2 splitStatements:false
...
-- changeset liquibase-user:1757785640741-3 splitStatements:false
...
-- changeset liquibase-user:1757785640741-4 splitStatements:false
...
-- changeset liquibase-user:1757785640741-5 splitStatements:false
...
-- changeset liquibase-user:1757785640741-6 splitStatements:false
ALTER TABLE "public"."users" ALTER COLUMN  "created_at" SET DEFAULT NOW();
-- rollback ALTER TABLE "users" ALTER COLUMN "created_at" DROP DEFAULT;

-- changeset liquibase-user:1757785640741-7 splitStatements:false
...
-- changeset liquibase-user:1757785640741-8 splitStatements:false
...
-- changeset liquibase-user:1757785640741-9 splitStatements:false
...
-- changeset liquibase-user:1757785640741-10 splitStatements:false
...
-- changeset liquibase-user:1757785640741-11 splitStatements:false
...
-- changeset liquibase-user:1757785640741-12 splitStatements:false
