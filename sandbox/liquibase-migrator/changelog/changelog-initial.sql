...
-- changeset liquibase-user:1757785618409-1 splitStatements:false
...
-- changeset liquibase-user:1757785618409-2 splitStatements:false
...
-- changeset liquibase-user:1757785618409-3 splitStatements:false
...
-- changeset liquibase-user:1757785618409-4 splitStatements:false
...
-- changeset liquibase-user:1757785618409-5 splitStatements:false
...
-- changeset liquibase-user:1757785618409-6 splitStatements:false
...
-- changeset liquibase-user:1757785618409-7 splitStatements:false
...
-- changeset liquibase-user:1757785618409-8 splitStatements:false
...
-- changeset liquibase-user:1757785618409-9 splitStatements:false
ALTER TABLE "public"."users" ADD CONSTRAINT "users_username_key" UNIQUE ("username");
-- rollback -- Rollback: DROP CONSTRAINT "users_username_key" from "users"
-- Note: Skipped due to PostgreSQL limitations with IF EXISTS for constraints

-- changeset liquibase-user:1757785618409-10 splitStatements:false
CREATE INDEX "idx_categories_parent_id" ON "public"."categories" USING btree("parent_id");
-- rollback DROP INDEX IF EXISTS "idx_categories_parent_id";

-- changeset liquibase-user:1757785618409-11 splitStatements:false
...
-- changeset liquibase-user:1757785618409-12 splitStatements:false
CREATE INDEX "idx_posts_user_id" ON "public"."posts" USING btree("user_id");
-- rollback DROP INDEX IF EXISTS "idx_posts_user_id";

-- changeset liquibase-user:1757785618409-13 splitStatements:false
...
-- changeset liquibase-user:1757785618409-14 splitStatements:false
CREATE INDEX "idx_posts_status" ON "public"."posts" USING btree("status");
-- rollback DROP INDEX IF EXISTS "idx_posts_status";

-- changeset liquibase-user:1757785618409-15 splitStatements:false
...
-- changeset liquibase-user:1757785618409-16 splitStatements:false
CREATE INDEX "idx_posts_created_at" ON "public"."posts" USING btree("created_at");
-- rollback DROP INDEX IF EXISTS "idx_posts_created_at";

-- changeset liquibase-user:1757785618409-17 splitStatements:false
...
-- changeset liquibase-user:1757785618409-18 splitStatements:false
...
-- changeset liquibase-user:1757785618409-19 splitStatements:false
CREATE INDEX "idx_comments_post_id" ON "public"."comments" USING btree("post_id");
-- rollback DROP INDEX IF EXISTS "idx_comments_post_id";

-- changeset liquibase-user:1757785618409-20 splitStatements:false
CREATE INDEX "idx_comments_user_id" ON "public"."comments" USING btree("user_id");
-- rollback DROP INDEX IF EXISTS "idx_comments_user_id";

-- changeset liquibase-user:1757785618409-21 splitStatements:false
CREATE INDEX "idx_comments_parent_id" ON "public"."comments" USING btree("parent_id");
-- rollback DROP INDEX IF EXISTS "idx_comments_parent_id";

-- changeset liquibase-user:1757785618409-22 splitStatements:false
CREATE INDEX "idx_comments_status" ON "public"."comments" USING btree("status");
-- rollback DROP INDEX IF EXISTS "idx_comments_status";

-- changeset liquibase-user:1757785618409-23 splitStatements:false
...
-- changeset liquibase-user:1757785618409-24 splitStatements:false
...
-- changeset liquibase-user:1757785618409-25 splitStatements:false
...
-- changeset liquibase-user:1757785618409-26 splitStatements:false
...
-- changeset liquibase-user:1757785618409-27 splitStatements:false
...
-- changeset liquibase-user:1757785618409-28 splitStatements:false
...
-- changeset liquibase-user:1757785618409-29 splitStatements:false
...
-- changeset liquibase-user:1757785618409-30 splitStatements:false
...
-- changeset liquibase-user:1757785618409-31 splitStatements:false
...
-- changeset liquibase-user:1757785618409-32 splitStatements:false
...
-- changeset liquibase-user:1757785618409-33 splitStatements:false
...
-- changeset liquibase-user:1757785618409-34 splitStatements:false
