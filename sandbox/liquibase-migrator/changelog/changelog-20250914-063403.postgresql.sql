...
-- changeset liquibase-user:1757831652566-1 splitStatements:false
...
-- changeset liquibase-user:1757831652566-2 splitStatements:false
...
-- changeset liquibase-user:1757831652566-3 splitStatements:false
...
-- changeset liquibase-user:1757831652566-4 splitStatements:false
...
-- changeset liquibase-user:1757831652566-5 splitStatements:false
...
-- changeset liquibase-user:1757831652566-6 splitStatements:false
ALTER TABLE "public"."users" ALTER COLUMN  "created_at" SET DEFAULT NOW();
-- rollback ALTER TABLE "users" ALTER COLUMN "created_at" DROP DEFAULT;

-- changeset liquibase-user:1757831652566-7 splitStatements:false
...
-- changeset liquibase-user:1757831652566-8 splitStatements:false
...
-- changeset liquibase-user:1757831652566-9 splitStatements:false
...
-- changeset liquibase-user:1757831652566-10 splitStatements:false
...
-- changeset liquibase-user:1757831652566-11 splitStatements:false
...
-- changeset liquibase-user:1757831652566-12 splitStatements:false
