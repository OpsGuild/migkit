...
-- changeset liquibase-user:1757842643973-1 splitStatements:false
...
-- changeset liquibase-user:1757842643973-2 splitStatements:false
...
-- changeset liquibase-user:1757842643973-3 splitStatements:false
...
-- changeset liquibase-user:1757842643973-4 splitStatements:false
...
-- changeset liquibase-user:1757842643973-5 splitStatements:false
...
-- changeset liquibase-user:1757842643973-6 splitStatements:false
...
-- changeset liquibase-user:1757842643973-7 splitStatements:false
...
-- changeset liquibase-user:1757842643973-8 splitStatements:false
...
-- changeset liquibase-user:1757842643973-9 splitStatements:false
ALTER TABLE "public"."users" ADD CONSTRAINT "users_username_key" UNIQUE ("username");
-- rollback -- Rollback: DROP CONSTRAINT "users_username_key" from "users"
-- Note: Skipped due to PostgreSQL limitations with IF EXISTS for constraints

-- changeset liquibase-user:1757842643973-10 splitStatements:false
CREATE INDEX "idx_categories_parent_id" ON "public"."categories" USING btree("parent_id");
-- rollback DROP INDEX IF EXISTS "idx_categories_parent_id";

-- changeset liquibase-user:1757842643973-11 splitStatements:false
...
-- changeset liquibase-user:1757842643973-12 splitStatements:false
CREATE INDEX "idx_posts_user_id" ON "public"."posts" USING btree("user_id");
-- rollback DROP INDEX IF EXISTS "idx_posts_user_id";

-- changeset liquibase-user:1757842643973-13 splitStatements:false
...
-- changeset liquibase-user:1757842643973-14 splitStatements:false
CREATE INDEX "idx_posts_status" ON "public"."posts" USING btree("status");
-- rollback DROP INDEX IF EXISTS "idx_posts_status";

-- changeset liquibase-user:1757842643973-15 splitStatements:false
...
-- changeset liquibase-user:1757842643973-16 splitStatements:false
CREATE INDEX "idx_posts_created_at" ON "public"."posts" USING btree("created_at");
-- rollback DROP INDEX IF EXISTS "idx_posts_created_at";

-- changeset liquibase-user:1757842643973-17 splitStatements:false
...
-- changeset liquibase-user:1757842643973-18 splitStatements:false
...
-- changeset liquibase-user:1757842643973-19 splitStatements:false
CREATE INDEX "idx_comments_post_id" ON "public"."comments" USING btree("post_id");
-- rollback DROP INDEX IF EXISTS "idx_comments_post_id";

-- changeset liquibase-user:1757842643973-20 splitStatements:false
CREATE INDEX "idx_comments_user_id" ON "public"."comments" USING btree("user_id");
-- rollback DROP INDEX IF EXISTS "idx_comments_user_id";

-- changeset liquibase-user:1757842643973-21 splitStatements:false
CREATE INDEX "idx_comments_parent_id" ON "public"."comments" USING btree("parent_id");
-- rollback DROP INDEX IF EXISTS "idx_comments_parent_id";

-- changeset liquibase-user:1757842643973-22 splitStatements:false
CREATE INDEX "idx_comments_status" ON "public"."comments" USING btree("status");
-- rollback DROP INDEX IF EXISTS "idx_comments_status";

-- changeset liquibase-user:1757842643973-23 splitStatements:false
...
-- changeset liquibase-user:1757842643973-24 splitStatements:false
...
-- changeset liquibase-user:1757842643973-25 splitStatements:false
...
-- changeset liquibase-user:1757842643973-26 splitStatements:false
...
-- changeset liquibase-user:1757842643973-27 splitStatements:false
...
-- changeset liquibase-user:1757842643973-28 splitStatements:false
...
-- changeset liquibase-user:1757842643973-29 splitStatements:false
...
-- changeset liquibase-user:1757842643973-30 splitStatements:false
...
-- changeset liquibase-user:1757842643973-31 splitStatements:false
...
-- changeset liquibase-user:1757842643973-32 splitStatements:false
...
-- changeset liquibase-user:1757842643973-33 splitStatements:false
...
-- changeset liquibase-user:1757842643973-34 splitStatements:false
