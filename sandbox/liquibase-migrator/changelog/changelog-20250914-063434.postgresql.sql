...
-- changeset liquibase-user:1757831685692-1 splitStatements:false
...
-- changeset liquibase-user:1757831685692-2 splitStatements:false
...
-- changeset liquibase-user:1757831685692-3 splitStatements:false
...
-- changeset liquibase-user:1757831685692-4 splitStatements:false
...
-- changeset liquibase-user:1757831685692-5 splitStatements:false
...
-- changeset liquibase-user:1757831685692-6 splitStatements:false
ALTER TABLE "public"."users" ALTER COLUMN  "created_at" SET DEFAULT NOW();
-- rollback ALTER TABLE "users" ALTER COLUMN "created_at" DROP DEFAULT;

-- changeset liquibase-user:1757831685692-7 splitStatements:false
...
-- changeset liquibase-user:1757831685692-8 splitStatements:false
...
-- changeset liquibase-user:1757831685692-9 splitStatements:false
...
-- changeset liquibase-user:1757831685692-10 splitStatements:false
...
-- changeset liquibase-user:1757831685692-11 splitStatements:false
...
-- changeset liquibase-user:1757831685692-12 splitStatements:false
